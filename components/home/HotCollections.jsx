  ...
  return (
    <section id="section-collections" className="no-bottom">
      <div className="container">
        ...
        {/* SKELETON LOADING - Static grid with explicit dimensions */}
        {loading ? (
          <div className="row">
          ...
          /* REAL DATA - Owl Carousel container */
          <OwlCarousel className="owl-theme" {...options}>
            {collections.map((item) => (
              <div className="nft_coll" key={item.id} style={{ margin: "5px" }}>
