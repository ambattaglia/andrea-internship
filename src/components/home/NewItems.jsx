...
const NewItems = () => {
  ...
  // OWL CAROUSEL CONFIG — EXACT SAME AS HOT COLLECTIONS
  const options = {
    loop: true,
    margin: 15,
    nav: true,
  ...
  return (
    <section id="section-items" className="no-bottom">
      <div className="container">
        ...
        {/* SKELETON LOADING — SAME STYLE AS HOT COLLECTIONS */}
        {loading ? (
          <div className="row">
              ...
              <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12" key={index}>
                <div className="nft__item">
                  ...
                  <div
                    ...
                    style={{ width: "120px", height: "20px", marginTop: "10px" }}
                  ></div>
          ...
          /* REAL DATA — OWL CAROUSEL EXACTLY LIKE HOT COLLECTIONS */
          <OwlCarousel className="owl-theme" {...options}>
            {items.map((item) => (
              <div className="nft__item" key={item.id} style={{ margin: "5px" }}>
